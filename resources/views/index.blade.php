        ...
        <div id="navbar" class="navbar-collapse collapse">
			...
			<div class="header-top-right">
				...
				<div class="signin">
					...
					<!-- pop-up-box -->
									<script type="text/javascript" src="{{URL::asset('style/js/modernizr.custom.min.js')}}"></script>    
									<link href="{{URL::asset('style/css/popuo-box.css')}}" rel="stylesheet" type="text/css" media="all" />
									<script src="{{URL::asset('style/js/jquery.magnific-popup.js')}}" type="text/javascript"></script>
									<!--//pop-up-box -->
